...
void *verde(void *tid)
{
printf( "\n Introduzca el tiempo en milisegundos para el color Verde: " );
scanf( "%d", &verdes);
	printf( "\n Introduzca el tiempo en milisegundos para el color Amarillo: " ); 
scanf( "%d", &amarrillo);
	printf( "\n Introduzca el tiempo en milisegundos para el color Rojo: " ); 
scanf( "%d", &rojos);
system("cls"); 
system("color A0"); 
Sleep(verdes);
